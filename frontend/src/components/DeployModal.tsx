...
type DeployData = Pick<
  App,
  "name" | "repo_url" | "domain" | "language_version" | "build_command" | "start_command"
>;
...
export function DeployModal({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const isLangChanged =
      isEditing && initialData && formData.language_version !== initialData.language_version;
                ...
                <Input
                  ...
                  value={
                    formData.domain === baseDomain
                      ? ""
                      : formData.domain.replace(`.${baseDomain}`, "")
                  }
