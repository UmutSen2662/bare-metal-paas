            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <div className="text-sm text-slate-700 truncate font-mono bg-slate-50 p-1.5 rounded mt-1">
                                    {app.repo_url}
                                </div>
                            </div>
                            <div>
                    ...
                    <div className="bg-white rounded-xl border border-slate-200 shadow-sm p-6">
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <code className="text-xs text-slate-600 bg-slate-50 block p-2 rounded mt-1 font-mono break-all">
                                    {app.build_command}
                                </code>
                            </div>
                            <div>
                ...
                <div className="lg:col-span-2 flex flex-col h-[600px]">
                    <div className="bg-slate-950 rounded-xl shadow-lg flex flex-col h-full overflow-hidden border border-slate-800">
                        ...
                        <div ref={logsContainerRef} className="flex-1 p-4 overflow-y-auto font-mono text-sm">
